...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'moreh' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'moreh' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'moreh' ),
		'repeat'    => esc_html__( 'Repeat All', 'moreh' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'moreh' ),
		'top center'    => esc_html__( 'Top Center', 'moreh' ),
		'top right'     => esc_html__( 'Top Right', 'moreh' ),
		'center left'   => esc_html__( 'Middle Left', 'moreh' ),
		'center center' => esc_html__( 'Middle Center', 'moreh' ),
		'center right'  => esc_html__( 'Middle Right', 'moreh' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'moreh' ),
		'bottom center' => esc_html__( 'Bottom Center', 'moreh' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'moreh')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'moreh' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'moreh')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'moreh' ),
		'italic'      => esc_html__( 'Italic', 'moreh' ),
		'bold'        => esc_html__( 'Bold', 'moreh' ),
		'bold italic' => esc_html__( 'Bold Italic', 'moreh' )
		);
