<?php
/**
 * Moreh functions and definitions
 *
 * @package Moreh
 * @since Moreh 0.0.1
 */
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_setup' ) ) {
	function moreh_setup() {
		global $content_width;

		/**
		 * Make theme available for translation
		 * Translations can be filed in the /languages/ directory
		 * If you're building a theme based on Moreh, use a find and replace
		 * to change 'moreh' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'moreh', trailingslashit( get_template_directory() ) . 'languages' );
		...
		register_nav_menus( array(
				'primary' => esc_html__( 'Primary Menu', 'moreh' )
			) );
		...
		if( moreh_is_woocommerce_active() && !of_get_option( 'woocommerce_breadcrumbs', '1' ) ) {
			add_action( 'init', 'moreh_remove_woocommerce_breadcrumbs' );
		}
	}
}

add_action( 'after_setup_theme', 'moreh_setup' );
...
if ( ! function_exists( '_wp_render_title_tag' ) ) {
	function moreh_slug_render_title() { ?>
		<title><?php wp_title( '|', true, 'right' ); ?></title>
	<?php }
	add_action( 'wp_head', 'moreh_slug_render_title' );
}
...
function moreh_fonts_url() {
	 ...
	 */
	$tenor_sans = _x( 'on', 'Tenor Sans font: on or off', 'moreh' );
	 ...
	 * Do not translate into your own language.
	 */
	$subset = _x( 'no-subset', 'Tenor Sans font: add new subset (cyrillic)', 'moreh' );
	 ...
	 * Do not translate into your own language.
	 */
	$kreon = _x( 'on', 'Kreon font: on or off', 'moreh' );
 ...
 */
function moreh_mce_css( $mce_css ) {
	$fonts_url = moreh_fonts_url();
...
add_filter( 'mce_css', 'moreh_mce_css' );
 ...
 * @return void
 */
function moreh_widgets_init() {
	register_sidebar( array(
			'name' => esc_html__( 'Main Sidebar', 'moreh' ),
			'id' => 'sidebar-main',
			'description' => esc_html__( 'Appears in the sidebar on posts and pages except the optional Front Page template, which has its own widgets', 'moreh' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Blog Sidebar', 'moreh' ),
			'id' => 'sidebar-blog',
			'description' => esc_html__( 'Appears in the sidebar on the blog and archive pages only', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Single Post Sidebar', 'moreh' ),
			'id' => 'sidebar-single',
			'description' => esc_html__( 'Appears in the sidebar on single posts only', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Page Sidebar', 'moreh' ),
			'id' => 'sidebar-page',
			'description' => esc_html__( 'Appears in the sidebar on pages only', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'First Front Page Banner Widget', 'moreh' ),
			'id' => 'frontpage-banner1',
			'description' => esc_html__( 'Appears in the banner area on the Front Page', 'moreh' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Second Front Page Banner Widget', 'moreh' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'First Front Page Widget Area', 'moreh' ),
			'id' => 'sidebar-homepage1',
			'description' => esc_html__( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Second Front Page Widget Area', 'moreh' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Third Front Page Widget Area', 'moreh' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Fourth Front Page Widget Area', 'moreh' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'First Footer Widget Area', 'moreh' ),
			'id' => 'sidebar-footer1',
			'description' => esc_html__( 'Appears in the footer sidebar', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Second Footer Widget Area', 'moreh' ),
			'id' => 'sidebar-footer2',
			'description' => esc_html__( 'Appears in the footer sidebar', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
	...
	register_sidebar( array(
			'name' => esc_html__( 'Third Footer Widget Area', 'moreh' ),
			'id' => 'sidebar-footer3',
			'description' => esc_html__( 'Appears in the footer sidebar', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
	...
	register_sidebar( array(
			'name' => esc_html__( 'Fourth Footer Widget Area', 'moreh' ),
			'id' => 'sidebar-footer4',
			'description' => esc_html__( 'Appears in the footer sidebar', 'moreh' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
...
add_action( 'widgets_init', 'moreh_widgets_init' );
...
function moreh_scripts_styles() {
	 ...
	 *     wp_dequeue_style( 'moreh-fonts' );
	 * }
	 * add_action( 'wp_enqueue_scripts', 'mytheme_dequeue_fonts', 11 );
	 */
	$fonts_url = moreh_fonts_url();
	if ( !empty( $fonts_url ) ) {
		wp_enqueue_style( 'moreh-fonts', esc_url_raw( $fonts_url ), array(), null );
	}
	...
	if ( is_singular() && comments_open() ) {
		...
		wp_localize_script( 'commentvalidate', 'comments_object', array(
			...
			'author'  => esc_html__( 'Please enter your name', 'moreh' ),
			'email'  => esc_html__( 'Please enter a valid email address', 'moreh' ),
			'comment' => esc_html__( 'Please add a comment', 'moreh' ) )
		);
	}
...
add_action( 'wp_enqueue_scripts', 'moreh_scripts_styles' );
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_content_nav' ) ) {
	function moreh_content_nav( $nav_id ) {
		global $wp_query;
		...
		<nav role="navigation" id="<?php echo $nav_id; ?>" class="<?php echo $nav_class; ?>">
			<h3 class="assistive-text"><?php esc_html_e( 'Post navigation', 'moreh' ); ?></h3>

			<?php if ( is_single() ) { // navigation links for single posts ?>

				<?php previous_post_link( '<div class="nav-previous">%link</div>', '<span class="meta-nav">' . _x( '<i class="fa fa-angle-left"></i>', 'Previous post link', 'moreh' ) . '</span> %title' ); ?>
				<?php next_post_link( '<div class="nav-next">%link</div>', '%title <span class="meta-nav">' . _x( '<i class="fa fa-angle-right"></i>', 'Next post link', 'moreh' ) . '</span>' ); ?>
			...
			elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) { // navigation links for home, archive, and search pages ?>
				...
				<?php echo paginate_links( array(
					...
					'type' => 'list',
					'prev_text' => wp_kses( __( '<i class="fa fa-angle-left"></i> Previous', 'moreh' ), array( 'i' => array( 
						'class' => array() ) ) ),
					'next_text' => wp_kses( __( 'Next <i class="fa fa-angle-right"></i>', 'moreh' ), array( 'i' => array( 
						'class' => array() ) ) )
				) ); ?>
 ...
 * simply create your own moreh_comment(), and that function will be used instead.
 *
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_comment' ) ) {
	function moreh_comment( $comment, $args, $depth ) {
		...
		case 'trackback' :
			...
			<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
				<article id="comment-<?php comment_ID(); ?>" class="pingback">
					<p><?php esc_html_e( 'Pingback:', 'moreh' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( esc_html__( '(Edit)', 'moreh' ), '<span class="edit-link">', '</span>' ); ?></p>
				...
				<article id="comment-<?php comment_ID(); ?>" class="comment">
					<header class="comment-meta comment-author vcard">
						...
						printf( '<cite class="fn">%1$s %2$s</cite>',
							...
							( $comment->user_id === $post->post_author ) ? '<span> ' . esc_html__( 'Post author', 'moreh' ) . '</span>' : '' );
						printf( '<a href="%1$s" title="Posted %2$s"><time itemprop="datePublished" datetime="%3$s">%4$s</time></a>',
							esc_url( get_comment_link( $comment->comment_ID ) ),
							sprintf( esc_html__( '%1$s @ %2$s', 'moreh' ), esc_html( get_comment_date() ), esc_attr( get_comment_time() ) ),
							get_comment_time( 'c' ),
							/* Translators: 1: date, 2: time */
							sprintf( esc_html__( '%1$s at %2$s', 'moreh' ), get_comment_date(), get_comment_time() )
						);
						?>
					</header> <!-- .comment-meta -->

					<?php if ( '0' == $comment->comment_approved ) { ?>
						<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'moreh' ); ?></p>
					<?php } ?>

					<section class="comment-content comment">
						<?php comment_text(); ?>
						<?php edit_comment_link( esc_html__( 'Edit', 'moreh' ), '<p class="edit-link">', '</p>' ); ?>
					</section> <!-- .comment-content -->

					<div class="reply">
						<?php comment_reply_link( array_merge( $args, array( 'reply_text' => wp_kses( __( 'Reply <span>&darr;</span>', 'moreh' ), array( 'span' => array() ) ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
					</div> <!-- .reply -->
				</article> <!-- #comment-## -->
			<?php
			break;
 ...
 */
function moreh_comment_form_default_fields( $fields ) {

	$commenter = wp_get_current_commenter();
	$req = get_option( 'require_name_email' );
	$aria_req = ( $req ? ' aria-required="true"' : "" );

	$fields[ 'author' ] = '<p class="comment-form-author">' . '<label for="author">' . esc_html__( 'Name', 'moreh' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' . '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>';

	$fields[ 'email' ] =  '<p class="comment-form-email"><label for="email">' . esc_html__( 'Email', 'moreh' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' . '<input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';

	$fields[ 'url' ] =  '<p class="comment-form-url"><label for="url">' . esc_html__( 'Website', 'moreh' ) . '</label>' . '<input id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></p>';

	return $fields;

}
add_action( 'comment_form_default_fields', 'moreh_comment_form_default_fields' );
 ...
 */
function moreh_comment_form_field_comment( $field ) {

	$field = '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun', 'moreh' ) . ' <span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>';

	return $field;

}
add_action( 'comment_form_field_comment', 'moreh_comment_form_field_comment' );
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_posted_on' ) ) {
	function moreh_posted_on() {
		$post_icon = '';
		...
		$date = sprintf( '<i class="fa %1$s"></i> <a href="%2$s" title="Posted %3$s" rel="bookmark"><time class="entry-date" datetime="%4$s" itemprop="datePublished">%5$s</time></a>',
			...
			sprintf( esc_html__( '%1$s @ %2$s', 'moreh' ), esc_html( get_the_date() ), esc_attr( get_the_time() ) ),
		...
		$author = sprintf( '<i class="fa fa-pencil"></i> <address class="author vcard"><a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a></address>',
			...
			esc_attr( sprintf( esc_html__( 'View all posts by %s', 'moreh' ), get_the_author() ) ),
			get_the_author()
		);

		// Return the Categories as a list
		$categories_list = get_the_category_list( esc_html__( ' ', 'moreh' ) );

		// Translators: 1: Permalink 2: Title 3: No. of Comments
		$comments = sprintf( '<span class="comments-link"><i class="fa fa-comment"></i> <a href="%1$s" title="%2$s">%3$s</a></span>',
			esc_url( get_comments_link() ),
			esc_attr( esc_html__( 'Comment on ' , 'moreh' ) . the_title_attribute( 'echo=0' ) ),
			( get_comments_number() > 0 ? sprintf( _n( '%1$s Comment', '%1$s Comments', get_comments_number(), 'moreh' ), get_comments_number() ) : esc_html__( 'No Comments', 'moreh' ) )
		);

		// Translators: 1: Date 2: Author 3: Categories 4: Comments
		printf( wp_kses( __( '<div class="header-meta">%1$s%2$s<span class="post-categories">%3$s</span>%4$s</div>', 'moreh' ), array( 
			'div' => array ( 
				'class' => array() ), 
			'span' => array( 
				'class' => array() ) ) ),
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_entry_meta' ) ) {
	function moreh_entry_meta() {
		// Return the Tags as a list
		$tag_list = "";
		if ( get_the_tag_list() ) {
			$tag_list = get_the_tag_list( '<span class="post-tags">', esc_html__( ' ', 'moreh' ), '</span>' );
		}

		// Translators: 1 is tag
		if ( $tag_list ) {
			printf( wp_kses( __( '<i class="fa fa-tag"></i> %1$s', 'moreh' ), array( 'i' => array( 'class' => array() ) ) ), $tag_list );
		}
	}
}
 ...
 * @return void
 */
function moreh_content_width() {
	if ( is_page_template( 'page-templates/full-width.php' ) || is_attachment() ) {
		global $content_width;
		$content_width = 1200;
	}
}
add_action( 'template_redirect', 'moreh_content_width' );
 ...
 */
function moreh_remove_more_jump_link( $link ) {
...
add_filter( 'the_content_more_link', 'moreh_remove_more_jump_link' );
 ...
 */
function moreh_continue_reading_link() {
	return '&hellip;<p><a class="more-link" href="'. esc_url( get_permalink() ) . '" title="' . esc_html__( 'Continue reading', 'moreh' ) . ' &lsquo;' . get_the_title() . '&rsquo;">' . wp_kses( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'moreh' ), array( 'span' => array( 
			'class' => array() ) ) ) . '</a></p>';
}


/**
 * Replaces "[...]" (appended to automatically generated excerpts) with the moreh_continue_reading_link().
 *
 * @since Moreh 0.0.1
 *
 ...
 */
function moreh_auto_excerpt_more( $more ) {
	return moreh_continue_reading_link();
}
add_filter( 'excerpt_more', 'moreh_auto_excerpt_more' );
 ...
 */
function moreh_new_contactmethods( $contactmethods ) {
	// Add Twitter
...
add_filter( 'user_contactmethods', 'moreh_new_contactmethods', 10, 1 );
 ...
 */
function moreh_add_menu_parent_class( $items ) {
...
add_filter( 'wp_nav_menu_objects', 'moreh_add_menu_parent_class' );
 ...
 */
if ( ! function_exists( 'moreh_get_social_media' ) ) {
	function moreh_get_social_media() {
		$output = '';
		$icons = array(
			array( 'url' => of_get_option( 'social_twitter', '' ), 'icon' => 'fa-twitter', 'title' => esc_html__( 'Follow me on Twitter', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_facebook', '' ), 'icon' => 'fa-facebook', 'title' => esc_html__( 'Like us on Facebook', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_googleplus', '' ), 'icon' => 'fa-google-plus', 'title' => esc_html__( 'Connect with me on Google+', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_linkedin', '' ), 'icon' => 'fa-linkedin', 'title' => esc_html__( 'Connect with me on LinkedIn', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_slideshare', '' ), 'icon' => 'fa-slideshare', 'title' => esc_html__( 'Follow me on SlideShare', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_dribbble', '' ), 'icon' => 'fa-dribbble', 'title' => esc_html__( 'Follow me on Dribbble', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_tumblr', '' ), 'icon' => 'fa-tumblr', 'title' => esc_html__( 'Follow me on Tumblr', 'moreh' ) ),
			array( 'url' => of_get_option( 'social_github', '' ), 'icon' => 'fa-github', 'title' => esc_html__( 'Fork me on GitHub', 'moreh' ) ),
 ...
 */
if ( ! function_exists( 'moreh_get_credits' ) ) {
	function moreh_get_credits() {
		$output = '';
		/*
                $output = sprintf( '%1$s <a href="%2$s" title="%3$s">%4$s</a>',
			esc_html__( 'Proudly powered by', 'moreh' ),
			esc_url( esc_html__( 'http://wordpress.org/', 'moreh' ) ),
			esc_attr( esc_html__( 'Semantic Personal Publishing Platform', 'moreh' ) ),
			esc_html__( 'WordPress', 'moreh' )
		);
                 * The code belw needs amending for translation purposes
                 */
                $output = 'This website is powered by <a href="http://wordpress.org">Wordpress</a>, using the <strong>Moreh</strong> theme from <a href="http://oldcastleweb.com">Old Castle Web Solutions</a>.';
 ...
 * @return void
 */
function moreh_theme_options_styles() {
	$output = '';
...
add_action( 'wp_head', 'moreh_theme_options_styles' );
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_before_woocommerce_wrapper' ) ) {
	function moreh_before_woocommerce_wrapper() {
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_after_woocommerce_wrapper' ) ) {
	function moreh_after_woocommerce_wrapper() {
 ...
 * @return void
 */
function moreh_is_woocommerce_active() {
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_setup_woocommerce_wrappers' ) ) {
	function moreh_setup_woocommerce_wrappers() {
		if ( moreh_is_woocommerce_active() && is_woocommerce() ) {
				add_action( 'moreh_before_woocommerce', 'moreh_before_woocommerce_wrapper', 10, 0 );
				add_action( 'moreh_after_woocommerce', 'moreh_after_woocommerce_wrapper', 10, 0 );		
		}
	}
	add_action( 'template_redirect', 'moreh_setup_woocommerce_wrappers', 9 );
}
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_woocommerce_before_main_content' ) ) {
	function moreh_woocommerce_before_main_content() {
	...
	add_action( 'woocommerce_before_main_content', 'moreh_woocommerce_before_main_content', 10 );
}
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_woocommerce_after_main_content' ) ) {
	function moreh_woocommerce_after_main_content() {
		echo '</div>';
	}
	add_action( 'woocommerce_after_main_content', 'moreh_woocommerce_after_main_content', 10 );
}
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_remove_woocommerce_sidebar' ) ) {
	function moreh_remove_woocommerce_sidebar() {
		if( ( is_shop() && !of_get_option( 'woocommerce_shopsidebar', '1' ) ) || ( is_product() && !of_get_option( 'woocommerce_productsidebar', '1' ) ) ) {
			remove_action( 'woocommerce_sidebar', 'woocommerce_get_sidebar', 10 );
		}
	}
	add_action( 'woocommerce_before_main_content', 'moreh_remove_woocommerce_sidebar' );
}
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_remove_woocommerce_breadcrumbs' ) ) {
	function moreh_remove_woocommerce_breadcrumbs() {
 ...
 * @return void
 */
if ( ! function_exists( 'moreh_set_number_woocommerce_products' ) ) {
	function moreh_set_number_woocommerce_products() {
	...
	add_action( 'init', 'moreh_set_number_woocommerce_products' );
}
